...
export type ImmutablePrimitive = Immutable.Map<unknown, unknown> | Immutable.List<unknown> | Immutalizer<unknown> | ImmutalizerObject<unknown> | ImmutalizerList<unknown[]> | string | number | boolean | symbol | String | Number | Boolean | Symbol | Element;
